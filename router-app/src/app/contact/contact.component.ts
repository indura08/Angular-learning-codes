...
export class ContactComponent {
  ...
  contactForm = new FormGroup({  //me form fgroup class eka objcet ekk balaporttu wenwa object ekak denna 
    ...
    senderName: new FormControl('', Validators.required),  //methna me form control ekk kiynne attama form eke ekama eka input feild ekak control kirimat awshya wana deyak , form group kiynne ewage formcontroller s ekt group krla thiygena inna container ekak wage deyk
